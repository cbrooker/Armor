...
function CalculateRisk() {
    ...
    if ($("#Question9").val().indexOf("Acetaminophen < 3000mg/day") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Acetaminophen >3000mg/day") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Aspirin < 3000") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Aspirin > 3000") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Diclofenac 100") != -1) { Yellow++; }
    ...
    if ($("#Question9").val().indexOf("Ibuprofen < 1200mg/day") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Ibuprofen >= 1200mg/day") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Indomethacin < 200") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Indomethacin >= 200") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Meloxicam < 15") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Meloxicam >= 15") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Naproxen < 1000") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("aproxen >= 1000") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Naproxen—PPI < 1000") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Naproxen—PPI >= 1000") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Celecoxib < 200") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Celecoxib >= 200") != -1) { Green++; }


    if ($("#Question9").val().indexOf("Acetaminophen/tramadol < 3000/300") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Acetaminophen/tramadol > 3000/300") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Codeine < 360") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Codeine > 360") != -1) { Green++; }

    if ($("#Question9").val().indexOf("Tramadol < 300") != -1) { Yellow++; }
    if ($("#Question9").val().indexOf("Tramadol > 300") != -1) { Green++; }
    ...
    if (Green == 0 && Yellow <= 1 && Blue == 0) { $(".GIRisk").val("Low risk"); $(".GIRisk").html(LowRisk).addClass("green"); }
    if ((Green == 1 || Green == 2) || (Yellow >= 2 && Blue == 0)) { $(".GIRisk").val("Moderate risk"); $(".GIRisk").html(ModerateRisk).addClass("yellow"); }
    if (Green >= 3 || (Green == 2 && Yellow >= 3) || Blue >= 1) { $(".GIRisk").val("High risk"); $(".GIRisk").html(HighRisk).addClass("red"); }
