...
namespace Armor.Data
{
    ...
    /// <summary>
    /// A class which represents the PreAssessment table in the Armor Database.
    /// This class is queryable through ArmorDB.PreAssessment 
    /// </summary>

	public partial class PreAssessment: INotifyPropertyChanging, INotifyPropertyChanged
	{
        partial void OnLoaded();
        partial void OnValidate(System.Data.Linq.ChangeAction action);
        partial void OnCreated();
