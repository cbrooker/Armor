...
{
    public partial class ArmorDB : IQuerySurface
    {
        ...
        public ArmorDB() 
        { 
            DataProvider = ProviderFactory.GetProvider("ArmorConnectionString");
            Init();
        }

        public ArmorDB(string connectionStringName)
        {
            DataProvider = ProviderFactory.GetProvider(connectionStringName);
            Init();
        }

		public ArmorDB(string connectionString, string providerName)
        {
        ...
        public Query<PreAssessment> PreAssessments { get; set; }
        public Query<ProgramEvaluatorStage2> ProgramEvaluatorStage2s { get; set; }
        public Query<ProgramEvaluatorStage3> ProgramEvaluatorStage3s { get; set; }
